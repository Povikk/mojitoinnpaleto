...
function updateSoundButton(){const button=document.querySelector('#sound-toggle');button.textContent=soundEnabled?'🔔':'🔕';button.title=soundEnabled?'Couper les alertes sonores':'Activer les alertes sonores';button.setAttribute('aria-label',button.title);button.classList.toggle('active',soundEnabled)}

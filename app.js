...
let teamStats=[];
let game={title:'Nouvelle partie',type:'Blind Test',scores:[],logs:[]};
...
async function refresh() {
  ...
  const [balanceResult, logsResult, expensesResult,raffleSettingsResult,raffleEntriesResult,teamStatsResult,gameSettingsResult,gameScoresResult,gameLogsResult] = await Promise.all([

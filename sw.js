const CACHE_NAME='mojito-inn-pwa-v127';
const APP_SHELL=['./','./index.html','./style.css','./reservation-view.css','./app.js','./config.js','./webm-muxer.js','./podium-render-worker.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./tropical-bar.webp','./podium-template.mp4'];
